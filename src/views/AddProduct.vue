...
<template>
    ...
    <!-- heading container -->
    <div class="flex  items-center px-[60px]">
        ...
        <!-- title -->
        <h1 class="text-center text-[30px] text-[rgb(73,73,73)] font-bold mx-auto pr-[80px] py-[60px]">Aggiungi prodotto</h1>

    </div>

    <section class="flex justify-center items-center h-[65vh]">
        ...
        <form @submit.prevent="submitForm" class="">
            ...
            <div class="border-2 w-[800px] p-[50px] border-gray-400 rounded-3xl">
                ...
                <div class="flex pb-[30px]">
                    <label for="title" class="w-[140px] font-bold">Title:</label>
